      ...
      <div className="flex h-[600px] flex-col rounded border bg-background shadow-xl">
        <div className="mt-3 h-full overflow-auto px-3" ref={scrollRef}>
          ...
          {!error && messages.length === 0 && (
            <div className="mx-8 flex flex-col items-center justify-center gap-3 text-center">
              <Bot size={28} />
              <p className="text-lg font-medium">
                Send a meassaege to start AI Chat!
              </p>
              <p>
                You can ask the Chatbot about me and it will find the relevant
                information on this website.
              </p>
              <p className="text-sm text-muted-foreground">
                PS: Expertly designed and build by Ben
              </p>
            </div>
          )}
        </div>
